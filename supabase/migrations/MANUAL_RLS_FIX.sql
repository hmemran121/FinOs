...
-- This will allow Super Admins to see all user data

-- Step 1: Create the is_super_admin() function
...
-- Step 2: Drop all existing restrictive policies and create bypass policies
...
-- PROFILES (special case - id column)
...
FOR SELECT
USING (id::text = auth.uid()::text OR is_super_admin());
